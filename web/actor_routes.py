...
async def create_actor_page(req):
    ...
    <input type="text" name="name" placeholder="Full Name (Actor / App / Website)" required>
    
    <div class="scard-label" style="margin-bottom:4px; color:var(--muted);">Select Category</div>
    <select name="category" style="width:100%; background:var(--bg3); border:1px solid var(--border); padding:12px; color:var(--text); border-radius:6px; margin-bottom:15px; outline:none; font-weight:600;" required>
        <option value="actor">🎭 Actor Profile</option>
        <option value="app">📱 App Profile</option>
        <option value="website">🌐 Website Profile</option>
    </select>

    <textarea name="bio" placeholder="Biography / Description Details..." style="width:100%; background:var(--bg3); border:1px solid var(--border); padding:12px; color:var(--text); border-radius:6px; min-height:100px; outline:none; margin-bottom:15px; font-family:inherit;" required></textarea>
    
    <div class="scard-label" style="margin-bottom:4px; color:var(--muted);">Search Tags (Comma Separated)</div>
    <input type="text" name="tags" placeholder="e.g. SRK, Netflix, Mod" style="width:100%; background:var(--bg3); border:1px solid var(--border); padding:12px; color:var(--text); border-radius:6px; margin-bottom:15px; outline:none;">
    
    <div class="scard-label" style="margin-bottom:8px; color:var(--muted);">Profile Photo / Icon</div>
